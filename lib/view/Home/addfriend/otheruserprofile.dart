...
class OtherUserProfile extends StatefulWidget {
  final String uid2;
  OtherUserProfile({Key? key, required this.uid2}) : super(key: key);
  @override
...
class _ProfileState extends State<OtherUserProfile> {
      ...
      builder: (BuildContext context, AsyncSnapshot<dynamic> snapshot) {
        ...
        return Column(
          ...
          children: [
            ...
            // buildButtonAdd(context, userDocument["userid"],
  ...
  // InkWell buildButtonAdd(BuildContext context, ouid, username, email) {
  //   return InkWell(
  //     onTap: () {
  ...
  //           .doc(ouid)
  //           .set({
  //             "userid":ouid,"username":username,"email":email,
  //           }).then((value) {
